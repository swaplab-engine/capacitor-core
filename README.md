...
This repository hosts the **Public Base Image** used by the [SwapLab Capacitor Builder Service](https://capacitor.swaplab.net).
...
This image (`swaplab-engine/capacitor-core`) serves as the foundation for our build pipeline. It contains the operating system, SDKs, build tools, and security scanners ensuring a stable and secure build environment for your hybrid applications.
...
| **Capacitor CLI** | v7.1.0 | Core Capacitor Framework |
...
```bash
docker pull ghcr.io/swaplab-engine/capacitor-core:latest
```
