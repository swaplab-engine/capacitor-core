# ===================================================================
# SWAPLAB ENGINE: CAPACITOR CORE (PUBLIC BASE IMAGE)
# Repo: swaplab-engine/capacitor-core
# Description: Public base image providing a transparent, secure, and 
# pre-configured environment for Capacitor Android & iOS builds.
# ===================================================================
FROM ubuntu:22.04 AS capacitor-core
...
# -------------------------------------------------------------------
# 5. Node.js, CLI, and Plugin Utilities
# -------------------------------------------------------------------
